...
void VisionRule::update(GameData& gameData)
{
	...
	filter.setPosition(X + BLOCK_SIZE / 2 - 540, gameData.player.getPosition().y + BLOCK_SIZE / 2 - 1080); // texture is 1080x2160
	...
	_rect1.setPosition(X + BLOCK_SIZE / 2 - 2040, 0); // 540 pour la texture + 1500 pour le rectangle
